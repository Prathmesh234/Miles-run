...
manifest = {'base_miles_sha':'70b89e11770fc9bac984e22cfff89c51cca44203',
            'patch_commit':'6ef4ae5581fa9e4558df22f39e92a24b67687a4b', 'scope':'job-local synchronous driver only; raw baseline is read-only',
            'reason':'Restore non-colocated PPO actor before broadcasting live tensors; offload after broadcast',

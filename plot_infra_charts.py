...
Reads files from the retained raw job-190 archive:
...
Writes PNG files to charts/. Use --evidence to point at the retained archive.
"""
...
parser.add_argument('--evidence', type=Path, default=ROOT / 'evidence-job-190' / 'job-190')

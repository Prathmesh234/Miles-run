...
**Telemetry gate: PARTIAL** · Slurm: RUNNING (0:0) · 10,052 source records · 0 collector errors.

Observed window: 2026-09-03T03:34:31.183255Z to 2026-09-03T03:34:46.730856Z (15.5 s).
...
|---|---|---|---:|---:|---:|---:|---:|---:|
| gpu-nodes-0 | trainer | 0/0 | — / — | — | — | — | — | 0.00197 |
| gpu-nodes-1 | trainer | 0/0 | — / — | — | — | — | — | 0.00141 |
| gpu-nodes-2 | rollout | 8/8 | — / — | — | — | — | — | 0.0019 |
| gpu-nodes-3 | rollout | 8/8 | 0 / 0 | 0.717 | 202 | — | 0 | 0.00139 |

## Failures and coverage

No collector-error records observed; this alone does not establish complete coverage.
- telemetry/sync-grpo-v14/gpu-nodes-0/nvidia-smi.jsonl: **missing**.
- telemetry/sync-grpo-v14/gpu-nodes-0/nvlink.jsonl: **missing**.
- telemetry/sync-grpo-v14/gpu-nodes-0/infiniband.jsonl: **missing**.
- telemetry/sync-grpo-v14/gpu-nodes-0/cpu-memory-numa.jsonl: **missing**.
- telemetry/sync-grpo-v14/gpu-nodes-0/lustre.jsonl: **missing**.
- telemetry/sync-grpo-v14/gpu-nodes-1/nvidia-smi.jsonl: **partial**.
- telemetry/sync-grpo-v14/gpu-nodes-1/nvlink.jsonl: **missing**.
- telemetry/sync-grpo-v14/gpu-nodes-1/infiniband.jsonl: **missing**.
- telemetry/sync-grpo-v14/gpu-nodes-1/cpu-memory-numa.jsonl: **missing**.
- telemetry/sync-grpo-v14/gpu-nodes-1/lustre.jsonl: **missing**.

...
**Telemetry gate: PARTIAL** · Slurm: RUNNING (0:0) · 4,717 source records · 0 collector errors.

Observed window: 2026-09-03T03:26:18.553319Z to 2026-09-03T03:26:28.228328Z (9.7 s).
...
- telemetry/sync-grpo-v13/gpu-nodes-0/nvidia-smi.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-0/nvlink.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-0/infiniband.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-0/cpu-memory-numa.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-0/lustre.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-1/nvidia-smi.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-1/nvlink.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-1/infiniband.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-1/cpu-memory-numa.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-1/lustre.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-2/nvidia-smi.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-2/nvlink.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-2/infiniband.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-2/cpu-memory-numa.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-2/lustre.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-3/nvidia-smi.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-3/nvlink.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-3/infiniband.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-3/cpu-memory-numa.jsonl: **missing**.
- telemetry/sync-grpo-v13/gpu-nodes-3/lustre.jsonl: **missing**.
- telemetry/lustre-sync-grpo-v13/gpu-nodes-0/lustre.jsonl: **partial**.
- telemetry/lustre-sync-grpo-v13/gpu-nodes-1/lustre.jsonl: **partial**.
- telemetry/lustre-sync-grpo-v13/gpu-nodes-2/lustre.jsonl: **partial**.
- telemetry/lustre-sync-grpo-v13/gpu-nodes-3/lustre.jsonl: **partial**.
